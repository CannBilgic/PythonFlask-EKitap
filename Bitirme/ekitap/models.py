...
class Book(db.Model):
    ...
    def __init__(self, id, type_id, numberofPages, ısbn, price, quantity, publisher_id, author_id, img_id, summary):
        self.id = id
    ...
    @classmethod
    def add_book(cls, type_id, numberofPages, ısbn, price, quantity, publisher_id, author_id, img_id, summary):
        book = cls(None, type_id, numberofPages, ısbn, price,
                   quantity, publisher_id, author_id, img_id, summary)
        db.session.add(book)
        db.session.commit()

    @classmethod
    def update_book(cls, id, type_id, numberofPages, ısbn, price, quantity, publisher_id, author_id, summary):
...
class Comments(db.Model):
    ...
    def __init__(self, id, users_id, book_id, comments):
        self.id = id
    ...
    @classmethod
    def add_comments(cls, user_id, book_id, comments):
        comments = cls(None, user_id, book_id, comments)
